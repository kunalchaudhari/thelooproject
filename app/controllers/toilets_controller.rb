class ToiletsController < ApplicationController
  ...
  private
    ...
    def toilet_params
      params.require(:toilet).permit(:lat, :lng, :name, :description, :open_hours, :closing_hours, :open_closing_note, :managed_by, :type, :genders, :no_of_toilets, :no_of_bathrooms, :no_of_urinals, :paid)
    end
end
